...
CREATE TRIGGER integration_event AFTER INSERT OR UPDATE OR DELETE ON raw_materials FOR EACH ROW EXECUTE FUNCTION capture_integration_event();
INSERT INTO integration_outbox(entity_type,entity_id,operation,data) SELECT 'raw_materials',id,'INSERT',integration_payload('raw_materials',to_jsonb(t)) FROM raw_materials t;
