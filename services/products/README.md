...
The first check creates and removes disposable accounts and farm data, and writes a sample PDF to `tmp/pdfs/traceability-check.pdf` for visual inspection.
