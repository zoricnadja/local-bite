...
| Fajl | Uloga |
|---|---|
| [libs/common/src/service_auth.rs](../../libs/common/src/service_auth.rs) | Kratkotrajni tehnički JWT za operaciju i business scope |
...
| [frontend/local-bite-frontend/src/app/core/auth/business-session.spec.ts](../../frontend/local-bite-frontend/src/app/core/auth/business-session.spec.ts) | Frontend automatizovana provera ponašanja. |
...
| [frontend/local-bite-frontend/src/app/core/services/business.service.ts](../../frontend/local-bite-frontend/src/app/core/services/business.service.ts) | Angular API adapter za HTTP pozive. Identifikatori: `BusinessService`. |
...
| [frontend/local-bite-frontend/src/app/features/business/create/create-business.component.css](../../frontend/local-bite-frontend/src/app/features/business/create/create-business.component.css) | Stilovi poslovnog ekrana. |
| [frontend/local-bite-frontend/src/app/features/business/create/create-business.component.html](../../frontend/local-bite-frontend/src/app/features/business/create/create-business.component.html) | Template poslovnog ekrana. |
| [frontend/local-bite-frontend/src/app/features/business/create/create-business.component.ts](../../frontend/local-bite-frontend/src/app/features/business/create/create-business.component.ts) | Komponenta poslovnog ekrana, stanje, akcije i eventualno inline template/stilovi. Identifikatori: `CreateBusinessComponent`. |
| [frontend/local-bite-frontend/src/app/features/business/business.routes.ts](../../frontend/local-bite-frontend/src/app/features/business/business.routes.ts) | Mapiranje ruta na komponente ili HTTP handlere. Identifikatori: `BUSINESS_ROUTES`. |
| [frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.css](../../frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.css) | Stilovi poslovnog ekrana. |
| [frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.html](../../frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.html) | Template poslovnog ekrana. |
| [frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.ts](../../frontend/local-bite-frontend/src/app/features/business/workers/add-worker.component.ts) | Komponenta poslovnog ekrana, stanje, akcije i eventualno inline template/stilovi. Identifikatori: `AddWorkerComponent`. |
| [frontend/local-bite-frontend/src/app/features/business/workers/workers-list.component.ts](../../frontend/local-bite-frontend/src/app/features/business/workers/workers-list.component.ts) | Komponenta poslovnog ekrana, stanje, akcije i eventualno inline template/stilovi. Identifikatori: `WorkersListComponent`. |
...
| [frontend/local-bite-frontend/src/app/shared/models/auth.models.ts](../../frontend/local-bite-frontend/src/app/shared/models/auth.models.ts) | Domenski, persistence ili frontend tip i povezane konstante. Identifikatori: `User`, `Business`, `LoginRequest`, `LoginResponse`, `RegisterRequest`, `UpdateUserRequest`, `AddWorkerRequest`, `WorkerOut`, `UpdateBusinessRequest`, `CreateBusinessRequest`, `CreateBusinessResult`. |
...
| [libs/common/src/middleware.rs](../../libs/common/src/middleware.rs) | Zajednički backend infrastrukturni ugovor/helper; videti dokument 04. Identifikatori: `from_request_parts`, `require_business`, `require_role`. |
...
| [scripts/verify-business-trace.cjs](../../scripts/verify-business-trace.cjs) | Integraciona regresiona skripta sa test podacima i Docker/SQL proverama. |
...
| [services/auth/src/dtos/create_business_request.rs](../../services/auth/src/dtos/create_business_request.rs) | Ulazni/izlazni ili međuservisni tip ugovora. |
| [services/auth/src/dtos/create_business_response.rs](../../services/auth/src/dtos/create_business_response.rs) | Ulazni/izlazni ili međuservisni tip ugovora. |
...
| [services/auth/src/dtos/update_business_request.rs](../../services/auth/src/dtos/update_business_request.rs) | Ulazni/izlazni ili međuservisni tip ugovora. |
...
| [services/auth/src/handlers/businesses.rs](../../services/auth/src/handlers/businesses.rs) | HTTP ulaz, extractors, uloge i mapiranje odgovora. Identifikatori: `trace_business`, `create_business`, `add_worker`, `get_business`, `list_workers`, `list_businesses`, `update_business`, `delete_business`. |
...
| [services/auth/src/models/businesses.rs](../../services/auth/src/models/businesses.rs) | Domenski, persistence ili frontend tip i povezane konstante. |
...
| [services/auth/src/repository/business_repository.rs](../../services/auth/src/repository/business_repository.rs) | SQL pristup vlasničkim tabelama i persistence operacije. Identifikatori: `new`, `insert_business`, `email_exists`, `find_by_id`, `find_by_owner`, `find_all`, `update_business`, `delete_business`, `list_workers_by_business`. |
...
| [services/auth/src/repository/repository.rs](../../services/auth/src/repository/repository.rs) | SQL pristup vlasničkim tabelama i persistence operacije. Identifikatori: `new`, `create_user`, `find_by_id`, `find_by_email`, `find_all`, `update_user`, `delete_user`, `set_business_id`, `clear_business_id`. |
| [services/auth/src/service/business_service.rs](../../services/auth/src/service/business_service.rs) | Poslovna pravila, koordinacija ili infrastrukturni helper servisa. Identifikatori: `new`, `create_business`, `add_worker`, `get_business`, `list_businesses`, `update_business`, `delete_business`, `list_workers`, `require_admin`. |
...
| [services/productions/src/repositories/batch_repository.rs](../../services/productions/src/repositories/batch_repository.rs) | SQL pristup vlasničkim tabelama i persistence operacije. Identifikatori: `new`, `list`, `find_by_id_and_business`, `insert_in`, `update`, `soft_delete`. |
...
| [services/products/src/dtos/clients.rs](../../services/products/src/dtos/clients.rs) | Ulazni/izlazni ili međuservisni tip ugovora. Identifikatori: `fetch_business_name`, `fetch_batch`. |
...
| [services/products/src/handlers/products_handler.rs](../../services/products/src/handlers/products_handler.rs) | HTTP ulaz, extractors, uloge i mapiranje odgovora. Identifikatori: `list_by_business`, `list`, `create`, `get_one`, `provenance`, `update`, `delete`. |
...
| [services/products/src/repositories/product_repository.rs](../../services/products/src/repositories/product_repository.rs) | SQL pristup vlasničkim tabelama i persistence operacije. Identifikatori: `new`, `find_all_by_business_id`, `find_all`, `list_filtered`, `find_by_id_and_business`, `find_by_id`, `find_by_qr_token`, `insert`, `update`, `soft_delete`, `set_qr_path`, `set_qr_path_returning`, `set_image_path`, `update_quantity`. |
...
| [services/products/src/services/product_service.rs](../../services/products/src/services/product_service.rs) | Poslovna pravila, koordinacija ili infrastrukturni helper servisa. Identifikatori: `dec`, `new`, `find_all_by_business_id`, `find_all`, `create`, `get_one`, `update`, `delete`, `validate_batch`, `authorize_read`. |
...
| [services/read-models/src/queries.rs](../../services/read-models/src/queries.rs) | Role-scoped dashboard, proizvođači i interni query porekla. Identifikatori: `entity`, `business_entities`, `dashboard`, `provenance`, `number`, `producers`. |
